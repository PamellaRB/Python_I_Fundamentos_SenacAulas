...
print("Status da sua conta é: ", ativo)
...
valor_unidade = 10.95
venda_disponivel = True
print("O produto " + produto + "esta com o valor de R$ " + str(valor_unidade))
print("Quantidade estoque: ", quantidade_estoque)
print("Valor unidade: ", valor_unidade)
print("Produto disponível para venda: ", venda_disponivel)
...
print("Teremos um evendo da " + nome + "no dia " + data_evento + ", que esta com uma quantidade de participantes esperada de" + str(qtd_participantes_esp))
print("Evento aberto para inscrições: ", inscricoes_abertas)
...
print("Idade: ", idade)
print("Saldo de Conta: ", saldo_conta)
print("Status CC: ", cartao_cred)
...
print("Identificação (ID): ", id)
print("Salário: ", salario)
print("Atualmente está empregado? ", empregado)
